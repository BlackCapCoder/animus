...
void CModI2CHost::OnReceive(int numBytes)
{
  ...
  if (Global.RefreshDelayDown != I2CRefreshDown || Global.RefreshDelayUp != I2CRefreshUp)
  {
    SetSubRefreshRate();
    I2CRefreshDown = Global.RefreshDelayDown;
    I2CRefreshUp = Global.RefreshDelayUp;
  }
...
void CModI2CHost::SetSubRefreshRate(void)
{
  // Wire.beginTransmission(I2C_GUEST_ADDRESS);
  Wire.write(5);
  Wire.write(Global.RefreshDelayDown);
  Wire.write(Global.RefreshDelayUp);
  // Wire.endTransmission();
}
